...
const SuccessToast = ({ message, onClose }) => {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[100] flex items-center w-full max-w-sm p-4 text-white bg-green-600 rounded-lg shadow-lg animate-in fade-in slide-in-from-right-5 duration-300">
      ...
      <button 
        onClick={onClose}
        className="ml-auto -mx-1.5 -my-1.5 bg-green-600 text-white hover:bg-green-700 rounded-lg p-1.5 inline-flex h-8 w-8 items-center justify-center transition-colors"
      >
