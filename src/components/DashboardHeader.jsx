...
const DashboardHeader = ({ userType, title, subtitle }) => {
    ...
    if (!displaySubtitle) {
        displaySubtitle = "Here are the status of the requested documents";
    }
                ...
                <div>
                    ...
                    <div className="bg-pup-maroon-header rounded-[20px] shadow-md absolute inset-10 flex items-center justify-between px-5">
                        ...
                        <div className="flex flex-col items-center px-1">
                            <h2 className="text-[22px] font-bold mb-4 text-center text-white leading-tight lg:text-[50px] uppercase">
                                {displayTitle}        
                            </h2>
