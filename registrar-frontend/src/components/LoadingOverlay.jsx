...
const LoadingOverlay = ({ isVisible = false, message = "Loading..." }) => {
  ...
  return (
    <div className="fixed inset-0 z-9999 flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm mt-10">
      <div className="flex flex-col items-center gap-4">
        ...
        <img
          src={risLogo}
          alt="RIS Logo"
          className="w-14 h-14 object-contain animate-bounce ml-75"
          style={{ animationDelay: "0s" }}
        />

        {/* Jumping message — letter by letter */}
        <div className="flex gap-0.5 ml-75">
