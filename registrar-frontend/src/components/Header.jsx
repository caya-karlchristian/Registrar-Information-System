...
function Header({ onMenuClick }) {
  ...
  // Fixed header, so all content is pushed below
  return (
    <header
      className="bg-pup-dark-maroon w-full shadow-sm fixed top-0 left-0 right-0 z-50 border-b-[5px] border-pup-yellow"
    >
