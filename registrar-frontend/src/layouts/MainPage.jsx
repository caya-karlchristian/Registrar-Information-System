    ...
    <LineLoading isVisible={loading} />
      ...
      <div className="absolute inset-0">
        ...
        <div className="hidden lg:flex flex-1 h-full items-center justify-center relative">
          ...
          <div className="relative flex items-center justify-center p-6 lg:p-12 lg:mt-30 animate-pulse-slow">
             <img 
               src={risLogo} 
               alt="RIS Branded Graphic" 
               className="mx-auto w-136 max-w-[90vw] drop-shadow-[0_35px_35px_rgba(0,0,0,0.5)] transition-transform hover:scale-105 duration-700"
             /> 
