...
class SendBulkNotificationJob implements ShouldQueue
{
    ...
    /**
     * Laravel automatically injects dependencies declared here from the
     * service container — this is the correct pattern for queued jobs.
     *
     * IMPORTANT: Do NOT call NotificationService::send() statically.
     * send() is an instance method; a static call throws a fatal PHP 8 Error
     * ("Non-static method cannot be called statically"), silently crashing
     * the job and preventing all admin notifications from being delivered.
     */
