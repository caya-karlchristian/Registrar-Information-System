...
|
|   reminder_claim         — sent 7 days after a request becomes
|                            ReadyToClaim and has not been collected.
|
|   reminder_final_warning — sent when the 90-day shred policy fires;
|                            the request is simultaneously forfeited.
|
| Run with:
